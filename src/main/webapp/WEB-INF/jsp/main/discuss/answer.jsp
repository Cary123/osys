...
<body>
	...
	<div class="main" id="main" style="margin-top: 70px; margin-left: 50px; margin-bottom: 400px">
		<div class="qa-content" data-qid="345570">
			<div class="qa-content-inner ">
				<div id="js-content-main">
					<div class="titleShow">问题：</div>
					<div class="ques-answer" style="margin-top: 0px">
						<div class="tag-img">
							<a href="javascript:void(0)" target="_blank"> <img
								height="40px"
								src="${pageContext.request.contextPath}/${question.user.photo }"
								title="${question.user.username }"></img> </a>
						</div>
						<div class="from-tag">
							来自<label style="color: green; font-size: 20px">&nbsp&nbsp&nbsp${question.user.username
								}&nbsp&nbsp&nbsp</label> <label style="color: gray; font-size: 15px">&nbsp&nbsp&nbsp<fmt:formatDate
									value="${question.question.questiontime }" type="both"
									pattern="yyyy-MM-dd HH:mm" /> </label>
						</div>
						<div class="question-content rich-text aimgPreview"
							id="questionInfo"
							data-questionid="${question.question.questionid}">
		...
		<div class="wd-top-slogan">
			<button id="showSendArea">我来回答</button>
		</div>
		...
		<div id="answerList">
			<c:forEach var="data" items="${answer}">
				<div class="ques-answer">
					...
					<div class="from-tag">
						来自<label style="color: green; font-size: 15px">&nbsp&nbsp&nbsp${data.user.username
								...
								value="${data.answer.answertime }" type="both"
								pattern="yyyy-MM-dd HH:mm" /> </label>
					</div>
					<div class="question-content rich-text aimgPreview">
						${data.answer.answercontent }</div>
				</div>
			</c:forEach>
		</div>
	</div>
	...
	<script
		src="${pageContext.request.contextPath}/static/js/main/answer.js"></script>
