			...
			<div class="row  border-bottom white-bg dashboard-header">
				<div id="mainBody" class="mainBody">
					<form role="form" id="uploadForm" enctype="multipart/form-data">
						<div class="form-group">
							<label for="name">章ID(不能修改) </label> <input type="text"
								readonly="readonly" class="form-control" id="chapterId"
								name="chapterId" value="${chapter.chapterid}">
						</div>
						<div class="form-group">
							<label for="name">章节号</label> <input type="text"
								class="form-control" id="chapterNameId" name="chapterNameId"
								value="${chapter.chapternameid}">
						</div>
						<div class="form-group">
							<label for="name">章节名</label> <input type="text"
								class="form-control" id="chapterName" name="chapterName"
								value="${chapter.chaptername}">
						</div>
						<div class="form-group">
							<label for="name">视频链接</label> <input type="file"
								class="form-control" id="file" name="file"
								value="${chapter.videourl}">
						</div>

					</form>
					<button class="btn btn-primary" onclick="uploadChapter()">修改</button>
				</div>
			</div>
		</div>
	</div>
