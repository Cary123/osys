					...
					<li class="active"><a href="#"> <i class="fa fa-th-large"></i>
						...
						<ul class="nav nav-second-level">
							<li><a href="javascript:void(0)"
								onclick="showAtRight('addCourseShow')">添加课程</a>
							</li>
							<li><a href="javascript:void(0)"
								onclick="showAtRight('editCourseShow')">修改课程信息</a>
							</li>
							<li><a href="javascript:void(0)"
								onclick="showAtRight('listCourseShow')">查看课程</a>
							</li>
						</ul></li>
					<li><a href="#"> <i class="fa fa-bar-chart-o"></i> <span
							class="nav-label">课程章管理</span> <span class="fa arrow"></span> </a>
						<ul class="nav nav-second-level collapse">
							<li><a href="javascript:void(0)"
								onclick="showAtRight('addChapterShow')">添加章</a>
							</li>
							<li><a href="javascript:void(0)"
								onclick="showAtRight('editChapterShow')">修改章信息</a>
							</li>
							<li><a href="javascript:void(0)"
								onclick="showAtRight('listChapterShow')">查看章</a>
							</li>
						</ul></li>
					<li><a href="#"> <i class="fa fa-bar-chart-o"></i> <span
				...
				<nav class="navbar navbar-static-top" role="navigation"
					...
					<ul class="nav navbar-top-links navbar-right">
						<li><span class="m-r-sm text-muted welcome-message">欢迎
								"${sessionScope.currentUser.username}" 登录成功</span>
						</li>
			...
			<div class="row  border-bottom white-bg dashboard-header">
				<div id="mainBody" class="mainBody">
					<form role="form" id="uploadForm" enctype="multipart/form-data">
						<div class="form-group">
							<label for="sectorId">节ID(不能修改) </label> <input type="text"
								readonly="readonly" class="form-control" id="sectorId"
								name="sectorId" value="${sector.sectorid}">
						</div>
						<div class="form-group">
							<label for="sectorNameId">节名编号</label> <input type="text"
								class="form-control" id="sectorNameId" name="sectorNameId"
								value="${sector.sectornameid}">
						</div>
						<div class="form-group">
							<label for="sectorName">节名称</label> <input type="text"
								class="form-control" id="sectorName" name="sectorName"
								value="${sector.sectorname}">
						</div>
						<div class="form-group">
							<label for="name">PDF上传</label> <input type="file"
								class="form-control" id="file" name="file"
								value="${sector.pdfurl}">
						</div>

					</form>
					<button class="btn btn-primary" onclick="modifySector()">修改</button>
				</div>
			</div>
		</div>
	</div>
